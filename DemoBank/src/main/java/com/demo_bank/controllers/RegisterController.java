...
import com.demo_bank.helpers.HTML;
import com.demo_bank.helpers.Token;
import com.demo_bank.mailMessenger.MailMessenger;
import com.demo_bank.models.User;
import com.demo_bank.repository.UserRepository;
...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser")User user,
                                 ...
                                 @RequestParam("confirm_password") String confirm_password) throws MessagingException, jakarta.mail.MessagingException {
