...
<!-- Start Of Transact OffCanvas -->
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            ...
            <!-- Payments Form Card -->
            <c:import url="transact_forms/payment_form.jsp"/>
            <!-- Transfer Form Card -->
            <c:import url="transact_forms/transfer_form.jsp"/>
            <!-- Deposit Form Card -->
            <c:import url="transact_forms/deposit_form.jsp"/>
            <!-- Withdraw Form Card -->
            <c:import url="transact_forms/withdraw_form.jsp"/>
